...
from qdatasets.QUBIC import QUBIKDataset
from qdatasets.multi_annotators_datasets import MultiAnnotatorsDataset
from qdatasets.transforms import Compose, Resize, RandomHorizontalFlip, ToTensor, Normalize, RandomAffine
...
class KidneyDataset(QUBIKDataset):
    def __init__(self, data_dir, mode, no_aug=False,
        ...
        super().__init__(data_dir, mode, no_aug, image_size, shard, num_shards, consensus_gt, soft_label_gt, erosion, no_annotators)
